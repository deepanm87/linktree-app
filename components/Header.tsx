        ...
        <Authenticated>
          <div className="flex gap-2 items-center bg-white/50 backdrop-blur-sm border border-white/20 p-2 rounded-lg">
            <Link
              ...
              className="inline-flex items-center gap-1 bg-linear-to-r from-blue-500 to-purple-600 text-white px-3 py-2 rounded-lg font-medium hover:from-blue-600 hover:to-purple-700 transition-all duration-200"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="border-purple-600 text-purple-700 hover:border-purple-700 hover:bg-purple-600 hover:text-white transition-all duration-200"
            >
